{ stdenv, libXScrnSaver, makeWrapper, fetchurl, unzip, atomEnv, libuuid, at-spi2-core }:
  ...
  linux = {
    ...
    buildCommand = ''
      ...
      patchelf \
        ...
        --set-rpath "${atomEnv.libPath}:${stdenv.lib.makeLibraryPath [ libuuid at-spi2-core ]}:$out/lib/electron" \
